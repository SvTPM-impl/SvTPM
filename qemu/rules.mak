...
%.o: %.c
	@echo "------------------%.c -> %.o-------------------"
	$(call quiet-command,$(CC) $(QEMU_INCLUDES) $(Qemu_C_Flags) $(QEMU_CFLAGS) $(QEMU_DGFLAGS) $(CFLAGS) $($@-cflags) -c -o $@ $<,"  CC    $(TARGET_DIR)$@")
%.o: %.rc
...
LINK = $(call quiet-command, $(LINKPROG) $(QEMU_CFLAGS) $(CFLAGS) $(LDFLAGS)  -o $@ \
       ...
       $(version-obj-y) $(call extract-libs,$1) $(LIBS) $(App_Link_Flags),"  LINK  $(TARGET_DIR)$@")
