...
/* C.8.8. From PowerPlat.c */
/* C.8.8.1. _plat__Signal_PowerOn_Path() */
/* Signal platform power on */
/*LIB_EXPORT int
ecall_plat__Signal_PowerOn_Path(
		      void
		      );*/
