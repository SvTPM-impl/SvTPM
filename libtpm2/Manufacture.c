...
// 20180303
/*define static variable libtpms_cbs used for callback*/
static struct libtpms_callbacks libtpms_cbs;

/*TPMLIB_GetCallbacks()
    Get static variable libtpms_cbs 
*/
...
/*TPMLIB_RegisterCallbacks()
    Register callback functions used for callback
    store callback functions in static variable libtpms_cbs 
    return 0 if success
*/

TPM_RESULT ecall_TPMLIB_RegisterCallbacks(void *cb){

    struct libtpms_callbacks *callbacks = (struct libtpms_callbacks *)cb;
